...
#[derive(Debug)]
pub struct BlockMosaicProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockMosaicProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockMosaic processing");
    
    let mut processor = BlockMosaicProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockMosaicProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockMosaicProcessor::new(false);
